...
class FAQ extends Component{
  ...
  render() {
    return (
      ...
      <p>Besides our engaging, beginner-friendly workshops, we also
      organize group trips to hack-a-thons, or programming competitions. We try
      to organize one trip per month, but sometimes there's more!</p>
      </div>
      <br/>
      <div className = "curved">
